...
config_dict = {
    ...
    'DATA_RANDOM_V': 10,
    'DATA_RANDOMFLIP': 0.5,
    'DATA_PSEUDO_GT': 'D:\\gkw\\data\\segmentation\\VOCdevkit\\VOC2012\\pseudo_gt\\VOC2012\\Segmentation',
...
config_dict['MODEL_SAVE_DIR'] = os.path.join(os.path.abspath(os.path.dirname("__file__")), 'model',
                                             config_dict['EXP_NAME'])
config_dict['TRAIN_CKPT'] = None
config_dict['LOG_DIR'] = os.path.join(os.path.abspath(os.path.dirname("__file__")), 'log', config_dict['EXP_NAME'])
config_dict['ROOT_DIR'] = "D:\\gkw\\data\\segmentation"
